<template>
  <div>
    <main>
      ...
      <p>
        This sentence is
        <b>bold</b>. If you like semantics, you might go with
        <strong>strong</strong> or
        <em>emphasized</em> text. If not,
        <i>italic</i> is still around.
      ...
      <p>
        ...
        <code>code</code>, as well as
        <kbd>keyboard input</kbd>,
        <samp>computer output</samp>, and
        <var>variables</var>.
      </p>
      <p>
        ...
        <cite>citation</cite>,
        <q>short quotation</q>,
        <abbr>abbreviation</abbr>, or
        <dfn>definition</dfn>. It might be
        <time>10:00pm</time>.
      </p>
      <address>
        <p>
